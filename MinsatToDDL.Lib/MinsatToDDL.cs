...
using MinsatToDDL.Lib.Models.Minsat;

namespace MinsatToDDL.Lib
{
    /// <summary>
    /// Class responsible for parsing Minsat documents and mapping them to ItemTransaction objects.
    /// </summary>
    public class MinsatToDDL
    {
        #region Enums
        ...
        /// <summary>
        /// Parsed Minsat invoice
        /// </summary>
        public Invoice ItemTransactionMinsat { get; set; }
        ...
        public DocumentType ItemTransactionMinsatDocumentType { get; set; } = DocumentType.Invoice;
        ...
        public ItemTransaction Parse(string fileContent)
        {
            ...
            ItemTransactionMinsat = document;
        ...
        private static Models.Party MapParty(Models.Minsat.Party party)
        {
        ...
        private static Models.Minsat.Party MapPartyReverse(Models.Party party)
        {
            if (party == null) return null;

            return new Models.Minsat.Party
            {
        ...
        //private static UnloadPlaceAddress MapUnloadPlaceAddress(Models.Minsat.Party party)
        //{
        //    if (party == null) return null;
        ...
        //private static Models.Minsat.Party MapUnloadPlaceAddressReverse(UnloadPlaceAddress address)
        //{
